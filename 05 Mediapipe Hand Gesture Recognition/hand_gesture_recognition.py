...
def is_membuka(landmark):
    ...
    # cek apakah seluruh pangkal berada di bawah seluruh ujung jari bersesuaian
    ...
    # cek apakah jari-jari membuka, hitung dari jarak ujung dibanding pangkal jari
    ...
    # cek posisi jempol, not yet implemented
